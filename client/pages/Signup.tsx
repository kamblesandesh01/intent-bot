      ...
      <div className="w-full max-w-sm flex flex-col">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-foreground mb-2">
            Build intent-aware conversations
          </h1>
          <p className="text-sm text-foreground/60 mb-3">
            Create your account to unlock full capabilities
          </p>
          <div className="space-y-1.5 text-xs text-foreground/70 bg-primary/5 border border-primary/20 rounded-lg p-3">
            <p className="font-medium text-primary">Unlock full potential:</p>
